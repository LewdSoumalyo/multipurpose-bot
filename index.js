...
const bot = new dbd.Bot({
  mobile: true, // you can change it to "true" if you want a mobile status
  token: "OTE4NDA2ODUxMDczMjg2MTc1.YbGzCA.bEKWk3Ucy4H7xoPDJx66LUU7bV0", // change TOKEN with your bot token
